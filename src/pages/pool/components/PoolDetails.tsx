...
export const PoolDetails = ({ pool, apr }: { apr: number; pool: TPool }) => {
	const shouldDisplayFlex = useBreakpointValue({ base: false, md: true })
	...
	return (
		...
		>
			<Flex
				...
				bg="rgb(255, 255, 255)"
				display={{ base: shouldDisplayFlex ? "flex" : "none", md: "flex" }}
				flex={1.5}
				flexDirection={{ base: "column", md: "row" }}
				rounded="1.25em"
				shadow="md"
					...
					{isShowingTotal ? (
						<VStack w="20rem">
							<Skeleton isLoaded={!isLoadingTotalPoolValues} rounded="0.8em" w="full">
								<Tooltip
									_dark={{ bg: "rgba(33, 33, 33, 0.8)", color: "white" }}
							...
							<HStack align="start" flex={1} spacing={3} w="full">
								...
								>
									...
									<Divider _dark={{ color: "white" }} color="black" w="90%" />
									<VStack pt={0.5} align="end" flex={1} fontSize="18" spacing={0.5} w="full">
										<Skeleton isLoaded={!isLoadingTotalUnderlyingAssets} rounded="0.8em" w="full">
											<HStack justify="end" w="full">
												<Text _dark={{ color: "white" }} color="black" fontSize="0.9em">
					...
					<Skeleton isLoaded={Boolean(pool)} rounded="0.8em" w="full">
						...
						>
							<Heading
								...
								fontSize="3xl"
							>
								<chakra.span _dark={{ color: "white" }} color="black" fontSize="18" pe={2}>
									Liquidity Provider
								</chakra.span>
							</Heading>
							<Heading
							...
							>
								...
								<chakra.span _dark={{ color: "white" }} color="black" fontSize="18" ps={2}>
									APR
								</chakra.span>
							</Heading>
						</Flex>
