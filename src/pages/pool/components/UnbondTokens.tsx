			...
			>
				...
				>
					<SliderTrack
						...
						rounded="full"
					>
						<SliderFilledTrack shadow="md" bgGradient="linear(45deg, #4b6cb7, brand.2)" />
					</SliderTrack>
					<SliderThumb bg="offwhite.2" h={{ base: 5, sm: 5 }} w={{ base: 5, sm: 5 }} />
				</Slider>
				<SimpleGrid columns={{ base: 4, sm: 4 }} h="full" spacing={2} w="full">
					{gaps.map((value, index) => (
						<Button
							...
							bg="gray.700"
							bgGradient={value === bondPercentage ? "linear(45deg,#4b6cb7,brand.2)" : ""}
							color="white"
