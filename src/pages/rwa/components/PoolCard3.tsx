				...
				<Flex direction="column" flex={1} gap={2}>
					...
					>
						<Text fontSize="0.75rem">
							The High Yield Corporate Loan USDC Pool provides strategic financing to a top tier
							counterparty in the digital asset ecosystem.
						</Text>
					</HStack>
				</Flex>
				<HStack>
					...
					>
						...
						<Heading fontSize="1rem">10.97%</Heading>
					</VStack>
