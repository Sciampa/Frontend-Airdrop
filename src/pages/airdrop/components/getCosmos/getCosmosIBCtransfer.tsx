		...
		const fetchPercentage = async (): Promise<void> => {
			try {
				const response = await axios.get<AddressData[]>(
					"https://raw.githubusercontent.com/Electron-Protocol/airdrop/main/Cosmos/Cosmos_percentage_IBCtransfer.json"
				)
...
export default CosmosIBCtransfer
