...
const NobleBonders = () => {
		...
		const fetchPercentage = async (): Promise<void> => {
			try {
				const response = await axios.get<AddressData[]>(
					"https://raw.githubusercontent.com/Electron-Protocol/airdrop/main/Neutron/Neutron_counts_DAO_percentage.json"
				)
	...
	return (
		<Flex alignItems="center" flexDirection="column">
			<Text fontSize={{ base: "0.7rem", md: "1rem" }} ml="0">
				DAO ALLOCATION
			</Text>
