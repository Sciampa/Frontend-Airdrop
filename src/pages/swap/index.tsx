...
import { Box, Button, Flex, Icon, Tag, useBreakpoint, useColorModeValue } from "@chakra-ui/react"
import { useChain } from "@cosmos-kit/react"
import { initialAtomToken, initialNeutronToken } from "@utils/tokens/helpers"
...
const Swap = () => {
	...
	useEffect(() => {
		let fromToken: Token = initialAtomToken
		let toToken: Token = initialNeutronToken
		...
		>
			...
			<AnimatePresence mode="wait">
				<MotionFlex
					...
					layout
					maxW={{ base: "sm", md: advancedMode ? "6xl" : "3xl" }}
					px={4}
              ...
              <SwapChart data={priceDataMock} />
					...
					>
						...
						<Flex align="center" direction="column" gap={3} pos="relative" zIndex={1}>
							<Button
								_hover={{ opacity: "1", shadow: "glowMd" }}
								animate={{
									rotate: isActive ? 360 : 0
								}}
								aria-label="Switch Input and Output token"
								as={motion.button}
								bg={useColorModeValue("rgba(33, 33, 33, 0.1)", "rgba(33, 33, 33, 0.3)")}
			...
			>
				...
				>
					...
					>
						Need Help?
						<Box
							borderTop="5vh solid #ffffff"
							_dark={{ borderTop: "5vh solid", borderTopColor: "#182848" }}
							w="0"
							h="0"
							mt="0.3em"
							mr="0.2em"
